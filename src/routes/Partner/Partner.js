  ...
  render() {
    return (
      <Content className="all-content">
        <QueueAnim component="ul" className="partner">
            <li key={'li1'}><div type={'bottom'} className="item"> 
...
>>>>>>> zido/master
                  ...
                  <div key={'li2div3'}><Button type="primary" size="large" onClick={()=>{window.open('http://register.agybk.com:15926/SelfOpenAccount/index.jsp?brokerage=0019001')}}> 立即开户 </Button></div>
              </div>
            </li>
            <li key="li3">
<<<<<<< HEAD
